...
void main() {
  ...
  testWidgets('TextField throws when not descended from an InkController', (WidgetTester tester) async {
    const Widget textField = TextField();
    await tester.pumpWidget(textField);
    final dynamic exception = tester.takeException();
    expect(exception, isFlutterError);
    expect(exception.toString(), startsWith('No InkController found.'));
  });
